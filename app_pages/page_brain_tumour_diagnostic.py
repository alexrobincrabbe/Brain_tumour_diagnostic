...
def page_brain_tumour_diagnostic_body():
    ...
    st.write(
        f"* You can download a set of MRI scans for live prediction. "
        f"You can download the images from [here](https://www.kaggle.com/datasets/rm1000/brain-tumor-mri-scans)."
        )
